...
// ControllerPodName retrieves the name of the controller-manager pod.
...
// DeployVerifyController verifies that the controller-manager is deployed and running correctly.
