...
var _ = Describe("LogArea Webhook", func() {
	var (
		obj       *etosv1alpha2.LogArea
		oldObj    *etosv1alpha2.LogArea
		defaulter LogAreaCustomDefaulter
		...
		providerID          = "logarea-provider-sample"
	)
	...
	BeforeEach(func() {
		...
		obj = &etosv1alpha2.LogArea{}
		oldObj = &etosv1alpha2.LogArea{}
		defaulter = LogAreaCustomDefaulter{FakeReader(&environmentRequest, nil)}
	...
	Context("When creating LogArea under Defaulting Webhook", func() {
		It("Should apply defaults when a required field is empty", func() {
			...
			Expect(obj.Labels).To(Equal(map[string]string{
				...
				"app.kubernetes.io/name":                                 "logarea-provider",
			}))
		})
	})
