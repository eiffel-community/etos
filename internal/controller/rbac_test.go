...
var _ = Describe("RBAC Rules", func() {
	...
	controllerExpectations := map[string][]expectedRule{
		"cluster_controller.go": {
			...
			{"", "services", []string{"get", "create", "patch", "delete"}},
			{"", "serviceaccounts", []string{"get", "create", "patch"}},
		...
		"environmentrequest_controller.go": {
			...
			{"etos.eiffel-community.github.io", "iuts", []string{"list", "delete"}},
			{"etos.eiffel-community.github.io", "executionspaces", []string{"list", "delete"}},
			{"etos.eiffel-community.github.io", "logarea", []string{"list", "delete"}},
			{"etos.eiffel-community.github.io", "providers", []string{"get"}},
