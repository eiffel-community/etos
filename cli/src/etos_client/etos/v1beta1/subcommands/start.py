...
"""Command line for starting ETOSv1beta1 testruns."""
...
class Start(SubCommand):
    ...
    Usage: etosctl testrun v1beta1 start [-v|-vv] [options] [--dataset=DATASET]... -i IDENTITY -s TEST_SUITE <cluster>
    ...
    meta: CommandMeta = CommandMeta(
        name="start", description="Start an ETOSv1beta1 testrun.", version="v1beta1"
    )
    ...
    def run(self, args: dict) -> None:
        ...
        warnings.warn("This is a beta version of ETOS! Don't expect it to work properly")
