...
type ExecutionSpaceSpec struct {
	...
	// Foo is an example field of ExecutionSpace. Edit executionspace_types.go to remove/update
...
type ExecutionSpace struct {
	...
	Spec   ExecutionSpaceSpec   `json:"spec,omitempty"`
	Status ExecutionSpaceStatus `json:"status,omitempty"`
}
