...
func (in *ETOS) DeepCopyInto(out *ETOS) {
	*out = *in
	...
	in.KeyService.DeepCopyInto(&out.KeyService)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ETOSKeyService) DeepCopyInto(out *ETOSKeyService) {
	*out = *in
	out.Image = in.Image
	if in.PublicKey != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ETOSKeyService.
func (in *ETOSKeyService) DeepCopy() *ETOSKeyService {
	if in == nil {
		return nil
	}
	out := new(ETOSKeyService)
	in.DeepCopyInto(out)
	return out
}
